export const blogsData = [
  {
    ...
    longDesc: `
      ...
      <ul class="list-disc pl-5 mb-4">
        ...
        <li>Maintain at least 2 feet of clearance.</li>
        <li>Gently clean condenser fins with water.</li>
        <li>Ensure proper ventilation.</li>
      </ul>
      <p>Avoid placing objects near the outdoor unit, as restricted airflow can overheat the compressor.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">4. Clean the Evaporator and Condenser Coils</h4>
      <p>Over time, dirt builds up on coils, reducing their ability to absorb and release heat effectively. Dirty coils can increase power consumption, cause uneven cooling, and lead to compressor damage.</p>
      <p>Professional cleaning once or twice a year ensures maximum heat exchange efficiency.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">5. Check Refrigerant Levels</h4>
      <p>Low refrigerant levels reduce cooling capacity and force the AC to work harder.</p>
      <p>Signs of low refrigerant include:</p>
      <ul class="list-disc pl-5 mb-4">
        <li>AC blowing warm air.</li>
        <li>Ice buildup on coils.</li>
        <li>Hissing sound (possible leak).</li>
      ...
      <p>Using fans can reduce cooling costs by up to 10%.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">9. Avoid Overworking the System</h4>
      <p>Keep doors and windows closed while AC is running. Avoid placing heat-producing appliances (like ovens and lamps) near the thermostat. Turn it off when not needed. Extreme settings force the compressor to run continuously, increasing energy bills and shortening system life.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">10. Keep Air Vents Clean and Unblocked</h4>
      ...
      <p>If you notice weak airflow in certain rooms, duct cleaning may be required.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">11. Improve Home Insulation</h4>
      <p>Proper insulation reduces heat gain and keeps cool air inside.</p>
      <p>Consider:</p>
      <ul class="list-disc pl-5 mb-4">
        <li>Insulating attic spaces</li>
        <li>Using reflective window films</li>
        <li>Sealing cracks in walls</li>
        <li>Installing energy-efficient windows</li>
      </ul>
      <p>Better insulation directly improves AC efficiency.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">12. Monitor Energy Bills</h4>
      <p>A sudden spike in electricity bills often signals AC inefficiency. If you notice higher costs, check filters, inspect for refrigerant leaks, and schedule professional servicing. Early detection prevents expensive repairs.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">13. Protect Your AC During Off-Season</h4>
      <p>When AC usage reduces (especially in cooler months):</p>
      <ul class="list-disc pl-5 mb-4">
        <li>Cover the outdoor unit properly</li>
        <li>Turn off main power supply</li>
        <li>Clean filters before storage</li>
        <li>Run the unit occasionally to prevent internal damage</li>
      </ul>
      ...
      <ul class="list-disc pl-5 mb-4">
        ...
        <li>Prevent sudden breakdowns</li>
  ...
  },
  {
    ...
    longDesc: `
      ...
      <h4 class="text-xl font-bold mt-6 mb-2">5. Improves Cooling Performance</h4>
      <p>Inefficient cooling often leads homeowners to lower the thermostat setting unnecessarily. When your AC is properly maintained, cooling is faster, temperature remains consistent, and humidity levels stay balanced. Proper servicing ensures optimal airflow, refrigerant balance, and system calibration.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">6. Reduces Risk of Peak-Season Breakdowns</h4>
  ...
  },
  {
    ...
    longDesc: `
      ...
      <p>Choose based on room structure and budget:</p>
      <ul class="list-disc pl-5 mb-4">
        <li><strong>Window AC:</strong> Budget-friendly, easy installation, best for small rooms.</li>
        <li><strong>Split AC:</strong> Quieter, better aesthetics, higher efficiency.</li>
        <li><strong>Inverter AC:</strong> Adjusts compressor speed, saves electricity, ideal for long hours.</li>
        <li><strong>Portable AC:</strong> Flexible and movable for temporary cooling.</li>
        <li><strong>Central AC:</strong> Best for cooling entire homes or commercial spaces.</li>
      </ul>

      <h4 class="text-xl font-bold mt-6 mb-2">3. Energy Efficiency Matters</h4>
      <p>Check the star rating and SEER ratio. High-efficiency units cost more initially but save money through reduced electricity bills over time.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">4. Climate and Location Consideration</h4>
      <p>Geographic location plays a role: hot/humid regions need dehumidification, while coastal areas may need anti-corrosion coatings.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">5. Installation and Space Requirements</h4>
      <p>Ensure proper wall strength for split units and ventilation space for outdoor units. Always hire certified technicians for installation.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">6. Noise Levels</h4>
      <p>Check decibel (dB) ratings, especially for bedrooms. Below 40 dB is very quiet; split and inverter ACs are usually quieter.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">7. Smart Features and Modern Performance</h4>
      <p>Look for Wi-Fi connectivity, smart thermostat compatibility, sleep mode, and auto-clean functions for improved convenience.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">8. Air Quality and Filtration</h4>
      <p>Consider models with HEPA filters, PM 2.5 filtration, and dehumidification modes to improve indoor air quality.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">9. Maintenance and Service Availability</h4>
      <p>Check for nearby service centers, warranty coverage (especially for the compressor), and spare parts availability.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">10. Budget Planning</h4>
      <p>Include purchase price, installation, and long-term electricity costs in your budget. Spending more upfront on efficiency often saves money.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">11. Inverter vs Non-Inverter AC</h4>
      <p>Inverter ACs are quieter and more efficient for daily use, while non-inverter units have a lower upfront cost but higher usage expenses.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">12. Check Power Consumption</h4>
      <p>Review the annual energy consumption and rated power input to estimate monthly electricity expenses.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">13. Consider Future Needs</h4>
      <p>Think about potential renovations or changes in room usage that might require a different capacity in the future.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">14. Eco-Friendly Refrigerants</h4>
      <p>Modern ACs use refrigerants like R32 or R410A, which have a lower environmental impact and better efficiency.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">15. Read Reviews and Compare Brands</h4>
      <p>Compare customer feedback and reliability ratings before finalizing your purchase to ensure long-term satisfaction.</p>

      <h4 class="text-xl font-bold mt-6 mb-2">Final Thoughts</h4>
      <p>An air conditioner is a long-term investment. By selecting the correct size, opting for energy-efficient models, and ensuring proper installation, you can enjoy optimal cooling and lower bills for years to come.</p>
    `,
